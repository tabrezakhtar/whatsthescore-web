...
function App() {
  ...
  const middleSection = matches.startTime ?
    <React.Fragment>
      <button type="button" disabled={isMatchDone} className="extra small-elevate surface-container" onClick={losePoint}>-</button>
      <button type="button" disabled={isMatchDone} className="extra small-elevate surface-container" onClick={winPoint}>+</button>
    </React.Fragment> :
    <button type="button" className="extra small-elevate surface-container" onClick={start}>Start</button>;
        ...
        {showRhs &&
          <div className="row middle-align wrap">
            <nav className="no-space vertical middle-align">
              <button className="small-margin surface-container round small small-elevate" onClick={undoPoint}>Undo Point</button>
              <button className="small-margin surface-container round small small-elevate" onClick={reset}>Reset</button>
              <button className="small-margin surface-container round small small-elevate" onClick={endMatch}>Finish match</button>
            </nav>
          </div>
        }
      </div>
