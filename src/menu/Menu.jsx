...
function Menu() {
  ...
  return (
      <ul>
        <li><NavLink exact activeClassName="header__menu-active" to="/">Home</NavLink></li>
        <li><NavLink exact activeClassName="header__menu-active" to="/matches">Matches</NavLink></li>
        <li><NavLink exact activeClassName="header__menu-active" to="/about">About</NavLink></li>
      </ul>
  );
}
